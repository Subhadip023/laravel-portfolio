    ...
    <aside class="w-64 bg-white border-r border-gray-200 flex flex-col hidden md:flex transition-all duration-300 z-20">
        ...
        <div class="flex-1 overflow-y-auto py-4">
            ...
            <nav class="space-y-1">
                ...
                <a href="{{ route('admin.hero.edit') }}" class="sidebar-item {{ request()->routeIs('admin.hero.*') ? 'active' : '' }} flex items-center gap-3 px-6 py-3 text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-indigo-600 transition-colors">
                    <i class="fas fa-home w-5 text-center"></i>
                    Hero Section
                </a>
