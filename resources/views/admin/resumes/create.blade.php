...
<div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
    <div>
        <h2 class="text-2xl font-bold text-gray-800">Create Resume</h2>
        <p class="text-sm text-gray-500 mt-1">Configure and build a new professional resume.</p>
    </div>
...
<form action="{{ route('admin.resumes.store') }}" method="POST" id="resume-form" 
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="md:col-span-2">
                ...
                <input type="text" name="title" value="{{ old('title') }}" required placeholder="e.g. Senior Laravel Developer Resume"
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}" required placeholder="Subhadip Chakraborty"
                       class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all">
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-600 mb-1.5">Email Address <span class="text-red-500">*</span></label>
                <input type="email" name="email" value="{{ old('email') }}" required placeholder="subhadip240420@gmail.com"
                       class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all">
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-600 mb-1.5">Phone Number</label>
                <input type="text" name="phone" value="{{ old('phone') }}" placeholder="6290765575"
                       class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all">
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-600 mb-1.5">Location (e.g. Kolkata, West Bengal)</label>
                <input type="text" name="location" value="{{ old('location') }}" placeholder="Kolkata, West Bengal"
                       class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all">
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-600 mb-1.5">LinkedIn Profile Link</label>
                <input type="text" name="linkedin" value="{{ old('linkedin') }}" placeholder="linkedin.com/in/subhadip-chakraborty"
                       class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all">
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-600 mb-1.5">Website / Other Portfolio Link</label>
                <input type="text" name="website" value="{{ old('website') }}" placeholder="github.com/subhadip023"
                       class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all">
            </div>
        </div>
    </div>
...
<script>
    function resumeBuilder() {
        return {
            // Initial structures
            education: [
                { institution: '', location: '', degree: '', enrolled: '', expected: '', percentage: '' }
            ],
            experience: [], // Optional experience section defaults empty
            training: [
                { organization: '', location: '', title: '', start_date: '', end_date: '' }
            ],
            projects: [
                { title: '', link: '', points: [''] }
            ],
