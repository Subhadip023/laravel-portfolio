        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="mb-6">
                ...
                <div class="bg-white border border-gray-200 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-indigo-500 transition-all">
                    <div id="quill-editor" style="height: 350px;">{!! old('description', $project->description) !!}</div>
                </div>
                <input type="hidden" name="description" id="hidden-description" value="{{ old('description', $project->description) }}">
                @error('description')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
