    ...
    <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            <p class="mb-8 leading-relaxed text-xl">
                We're working on something amazing! My projects will be available here soon.
            </p>
        ...
        <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
            <img class="object-cover object-center rounded" alt="Coming Soon" src="https://dummyimage.com/600x400/3b82f6/ffffff&text=Coming+Soon">
        </div>
    </div>
</section>
@endsection
